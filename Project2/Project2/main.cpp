//////-------Snake Game-----------//////////
/////----By: Poshan Pandey--------/////////
//////-Roll:161724,BESE(day)------/////////
/* this program terminates itself it it eat ourself and if collide with wall*/
/*I made this program on the primarily basis on a tutorial by cherno projects. That was really helpfull. I learnt a lot of stuffs about opengl.*/
/*It also adds square to its length if it eats a red square*/
#include <ctime>
#include <deque>
#include <GL/glut.h>
...
char title[] = "Snake Game by Poshan Pandey";
...
void spawnFood() {
	if (!food_available) {
		while (true) {
			...
			// It prodces a temporary random coordinate
...
void display() {
	...
	// The side order is front, back, left, right, top, bottom
